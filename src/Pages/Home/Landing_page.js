...
function Landing_page() {
  return (
    <div className="ml-16 h-auto w-full flex flex-col sm:mb-[40%] items-center bg-white  sm:ml-0 sm:w-full  ">
      ...
      <motion.div
        className="flex justify-around items-center   mt-[17%] sm:hidden  pt-5 w-full"
      ...
      <div className="flex mt-[2%] sm:w-full  relative">
        <motion.div
          ...
          className="w-[90%] bg-color-13 h-fit sm:hidden ">
      ...
      <div className="w-[80%] flex  mt-[7%] items-center justify-around sm:w-full  sm:flex-col-reverse ">
        ...
        <motion.div
          ...
          className="w-1/2 flex flex-col gap-3 sm:w-full sm:items-center">
      ...
      <div className="w-[80%] flex mt-[7%] items-center justify-around sm:w-full  sm:flex-col-reverse ">
        <div className="w-1/2 sm:w-[90%]">
          <motion.img
            ...
            className="h-60 ml-10 w-80"
            src={landingimage5}></motion.img>
        </div>
        <motion.div
          initial={{ y: -150 }}
          animate={{ y: 0 }}
      ...
      <div className="w-[80%] flex mt-[7%] items-center justify-around ml-10 sm:w-full sm:flex-col">
        ...
        <div className="w-1/2 sm:w-[85%]">
          <motion.img
            ...
            className="ml-10 sm:ml-0"
            src={landingimage6}></motion.img>
        </div>
      </div>

      <div className="flex flex-col w-[50%]  mt-[11%]    items-center sm:w-full sm:items-center sm:justify-center sm:mt-[15%]">
        <h1 className="text-5xl font-extrabold mt-2 text-[#0D0E2F] sm:text-2xl">
          {" "}

    ...
    return (
      ...
      <div className=" bg-color-3 dark:bg-color-11 transition-all duration-500 ease-in-out z-[9] dark:text-white dark:border absolute my-[10%] top-0 w-4/6 px-6 py-10 rounded-3xl flex flex-col  items-center justify-center  shadow-md shadow-slate-600 xs:flex-col xs:w-11/12   ">
                ...
                <div className="py-2">
                    ...
                    <textarea rows={5} cols={110} className="rounded-2xl  px-2 xs:h-24 w-4/5 xs:w-11/12   dark:bg-zinc-800 dark:border  transition-all ease-in-out border-white focus:ring-[#6868ea] bg-color-3  duration-500 focus:border-color-17 border-[2px] outline-none"
                        name="descrp"
                        onChange={(e) => onHandleChange(e)}

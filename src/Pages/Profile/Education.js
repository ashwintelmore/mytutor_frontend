...
function Education() {
  return (
    ...
    <div className=" bg-[#98cfe9] w-4/6 h-auto p-1 rounded-3xl flex flex-col items-center justify-center  shadow-md shadow-black xs:flex-col xs:w-11/12">
      ...
      <div className="flex xs:w-full xs:justify-evenly gap-2 w-2/5 justify-between"><button className="xs:w-2/5 bg-orange-400 rounded-xl p-2 w-2/5" >Add</button> <button  className=" xs:w-2/5 bg-orange-400 rounded-xl p-2 w-2/5">Cancel</button></div>
     </div>
     </div>
  );
}

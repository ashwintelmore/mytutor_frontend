 ...
 function Calender() {
   return (
     <div className="w-full bg-white rounded-3xl ml-16 h-screen ">
       <div className=" w-[70%]  justify-center dark:bg-color-11 dark:text-white flex-col  flex gap-5   ">
        
          <h1 className="font-bold py-4 px-4 font-font-primary dark:text-white text-color-14 text-6xl">
            Heading
          </h1>

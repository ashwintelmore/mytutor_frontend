...
const VerticalNav = () => {
  ...
  return (
    <div className=" fixed left-0 footer w-16 h-screen  bg-[#EAF0FF] text-lg flex flex-col dark:bg-zinc-900 dark:text-yellow-300 xs:bg-orange-100 xs:h-14 xs:p-1 xs:fixed  xs:bottom-0 sm:z-[5]  sm:h-[10%] sm:text-2xl sm:p-1 sm:fixed  sm:bottom-0 sm:w-full   ">

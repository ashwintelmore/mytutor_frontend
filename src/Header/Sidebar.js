...
const Sidebar = ({ open, toggle, }) => {
  ...
  return (
    <>
      <div className={`sidebar sm:z-[11] sm:mt-2 z-[11] dark:bg-zinc-700 dark:text-white dark:border w-[330px] sm:w-[270px] h-screen bg-white  rounded-r-3xl left-0 top-0 fixed transition-all ease-in-out delay-100 ${open ? "sidebar-open translate-x-[0%]" : "sidebar-close -translate-x-full"}`}>
